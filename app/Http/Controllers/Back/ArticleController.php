        ...
        if (request()->ajax())
        {
            ...
            ->addColumn('button', function($article) {
                return '<div class="text-center">
                            <a href="admin/articles/'.$article->id.'" class="btn btn-secondary">Detail</a>
    ...
    public function store(ArticleRequest $request)
{
    ...
    // Redirect to the admin/articles route with a success message
    return redirect()->route('articles.index')->with('success', 'Data Article has been created');
}

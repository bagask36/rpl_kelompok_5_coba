                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xxl-6">
                        <div class="text-center my-5">
                            <h1 class="fw-bolder mb-3">Peraturan Undang-Undang</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        <iframe class="img-fluid rounded mb-5 mb-lg-0" id="pdf-preview"
                            src="{{ asset('blog') }}/assets/pdf/UU_42_Tahun_2009.pdf"
                    ...
                    <div class="col-lg-6">
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2">
                                ...
                                <p class="lead fw-normal text-muted mb-0 fs-10">Undang-Undang No. 42 Tahun 2009
                            </li>
                        </ul>
                        <p class="mb-0"><a href="{{ asset('blog') }}/assets/pdf/UU_42_Tahun_2009.pdf"
            ...
            <div class="container px-5 my-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 order-first order-lg-last">
                        <iframe class="img-fluid rounded mb-5 mb-lg-0" id="pdf-preview"
                            src="{{ asset('blog') }}/assets/pdf/UU_PPh.pdf"
                            style="width: 100%; height: 400px;"></iframe>
                    </div>
                    <div class="col-lg-6">
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2">
                                <i class="bi bi-check-circle text-primary fs-5"></i>
                                <p class="lead fw-normal text-muted mb-0 fs-10">Undang-Undang Pajak Penghasilan dan
                                    Peraturan Pelaksanaan</p>
                            </li>
                        </ul>
                        <p class="mb-0"><a href="{{ asset('blog') }}/assets/pdf/UU_PPh.pdf" target="_blank">Lihat
                                PDF</a></p>
                    </div>
